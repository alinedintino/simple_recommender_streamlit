...
from config import score_based_cfg, content_based_cfg
...
st.markdown('# Movie Recommendation Prototype')

#add panel and search button
...
recommended_movie_num = st.sidebar.slider("How many recommendations do you want to see?", min_value=5, max_value=10)
if recommended_movie_num:
    const.MOVIE_NUMBER = recommended_movie_num
show_score = st.sidebar.checkbox("Show movie score")
...
#recommended movies based on weighted average 
